...
full_model_prefix = '../multitask-lm/exp/afp/models/stories_afp/sentagree'
simple_model_prefix = '../multitask-lm/exp/afp/models/stories_afp/sentagree/ignore_simple'
...
def mk_tasks(exp):
    def helper(is_full = True):
        ...
        for model in models:
            ...
            lm_output = 'lm_output/sentagree/afp/{}/{}'.format(attr, model)
            ...
            analyze_output = 'results/sentagree/afp/{}/{}'.format(attr, model)
